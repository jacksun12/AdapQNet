...
- **Supported Models**: MobileNetV2, MobileNetV3, EfficientNet
...
│   │   ├── mbv2_logs/          # Training logs
│   │   ├── mbv2_sampled_subnets/ # Sampled subnetworks
│   │   ├── mbv2_best_models/   # Best model checkpoints
...
│   ├── quick_compression_calc.py     # Compression calculator
│   ├── example_precision_mapping.json # Precision mapping example
│   ├── latency_analysis_results.json # Analysis results
│   ├── dual_core_tensor_analysis_results.json # Dual-core results
│   ├── compression_result*.json      # Compression results
